...
public class OfficerDTO {
    ...
    public OfficerDTO(String officerID, String officerName, String officerAdress, String officerNic, int officerTP) {
    ...
    public String toString() {
        return "OfficerDTO{" + "officerID=" + officerID + ", officerName=" + officerName + ", officerAdress=" + officerAdress + ", officerNic=" + officerNic + ", officerTP=" + officerTP + '}';
    }
